                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-sm-flex justify-content-start">
                            <h1 class="h3 mb-0 ml-2 text-gray-800">Cambiar contraseña</h1>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    Cambiar contraseña de <strong>"<?php echo $sesion['AsesorUsuario'] ?>"</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password1" autocomplete="new-password"
                                                        autofocus="" class="form-control" required="" id="id_password1">
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password2" autocomplete="new-password"
                                                        class="form-control" required="" id="id_password2">
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" name="actualizarPass">Guardar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
