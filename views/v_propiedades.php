                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-sm-flex justify-content-start">
                            <h1 class="h3 mb-0 ml-2 text-gray-800">Propiedades</h1>
                        </div>
                            ...
                            <form action="" method="get">
                                <div class="row">
                                    <div class="form-group col-sm-2">
                                        ...
                                        <input type="text" name="folio" class="form-control" id="id_first_name">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="">Titulo de la Publicacion</label>
                                        <input type="text" name="titulo" class="form-control" id="id_last_name">
                                    </div>
                                    <div class="form-group col-sm-3">
                                ...
                                <div style="padding-top: 32px;">
                                    ...
                                    <a href="v_propiedades.php" style="border: none; padding: 4px 10px;"
