                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="d-sm-flex justify-content-start">
                            <h1 class="h3 mb-0 ml-2 text-gray-800">Propietarios</h1>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" novalidate="">
                                        <input type="hidden" name="csrfmiddlewaretoken"
                                            value="iM3Tsx03ejDYcBML0Ixkdqd1rC0UqpuA7tk8VavGTEh1GxHD1ZQPxWggXiLnmrPH">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="id_nombre"> Nombre:</label>
                                                    <input type="text" name="nombre" maxlength="50" class="form-control"
                                                    id="id_nombre" required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="a_paterno" maxlength="50"
                                                        class="form-control" id="id_a_paterno"required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="a_materno" maxlength="50"
                                                        class="form-control" id="id_a_materno" required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="correo_electronico" maxlength="254"
                                                        class="form-control" id="id_correo_electronico" required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="telefono" maxlength="10"
                                                        class="form-control" id="id_telefono" required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="celular" maxlength="10"
                                                        class="form-control" id="id_celular" required>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="direccion" cols="40" rows="4" class="form-control"
                                                        id="id_direccion" required></textarea>
                                                    <span class="red"> </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <button name="registrarPropietarios" type="submit" class="btn btn-primary">Guardar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
